  ...
  override fun CompilerPluginRegistrar.ExtensionStorage.registerCompilerExtensions(
    ...
    val options =
      MetroOptions.buildOptions {
        ...
        // Component sharding options (our custom additions)
        module.directives.singleOrZeroValue(MetroDirectives.ENABLE_COMPONENT_SHARDING)?.let {
          enableComponentSharding = it
        }
