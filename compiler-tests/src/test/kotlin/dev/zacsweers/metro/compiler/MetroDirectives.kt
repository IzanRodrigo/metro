...
object MetroDirectives : SimpleDirectivesContainer() {
  ...
  val COMPONENT_SHARDING by
    valueDirective("Enable/disable component sharding of binding graphs.") { it.toBoolean() }
  val KEYS_PER_GRAPH_SHARD by
    valueDirective("Maximum number of binding keys per component shard.") { it.toInt() }
